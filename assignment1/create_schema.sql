-- Oracle to PostgreSQL guide: http://www.sqlines.com/oracle-to-postgresql

-- Default is ISO: https://www.postgresql.org/docs/current/static/runtime-config-client.html#GUC-DATESTYLE
